...
function ProductDetailPage(props) {
  ...
  // ¿Está en favoritos según el contexto?
  ...
  // Usamos la función del contexto (se encarga de persistir/actualizar)
  ...
  return (
    <div className="container">
      ...
      <p>
        <strong>Available Stock:</strong> {stockDisponible}
      </p>
      <p>
      ...
      {sellerRating ? (
        <p>
          <strong>⭐ Seller Rating:</strong> {sellerRating} / 5
        </p>
      ) : (
      ...
      <div
        ...
        style={{ margin: '40px auto 0 auto', maxWidth: 500, width: '100%' }}
      >
        ...
        {messages
          ...
          .map((q) => {
            ...
            return (
              ...
              >
                <p>
                  <strong>{q.users?.nickname || 'User'}:</strong> {q.content}
                </p>
        ...
        {currentUser && !isOwner && (
          <div style={{ marginTop: 20 }}>
            ...
            <button
              ...
              disabled={messageLoading || !questionText.trim()}
              style={{ marginTop: 8 }}
            >
