...
export const SKILL_MIGRATION_MAP = {
  ...
  'teak care': 'Teak care',
  'paint & varnish': 'Paint preparation & touch-ups',
  'paint & varnish (basic)': 'Paint preparation & touch-ups',
  ...
  'asian/japanese/sushi': 'Asian / Japanese cuisine',
  'plant-based/vegan': 'Plant-based menus',
  ...
  'healthy cuisine': 'Fresh & Healthy Cuisine',
  'casual & crew meal preparation': 'Produce crew meals at scale',
  'crew meal preparation': 'Produce crew meals at scale',
  'catering for charters/events': 'Execute charter turnaround',
  'waste minimization': 'Apply HACCP workflows',
  // Variantes legacy comunes
  'tender driving': 'RIB tender handling',
  ...
  'well presented': 'Well-groomed appearance',
  'good presentation': 'Well-groomed appearance',
  'good personal presentation': 'Well-groomed appearance',
  'well groomed': 'Well-groomed appearance',
  'well-groomed': 'Well-groomed appearance',
  'fit': 'Physically fit',
  'physically fit': 'Physically fit',
  'fit and active': 'Physically fit',
  'self starter': 'Self-starter mindset',
  'self-starter': 'Self-starter mindset',
  'self starter mindset': 'Self-starter mindset',
  'self-starter mindset': 'Self-starter mindset',
  'initiative': 'Self-starter mindset',
};
...
export const DEPT_SPECIALTIES_SUGGESTIONS = {
  ...
  Deck: [
    ...
    {
      group: 'Sailing Yacht Seamanship',
      items: [
        'Sailing yacht seamanship',
        'Running rigging handling',
        'Winch operations',
        'Rope splicing (basic)',
        'Sail handling',
        'Mast climbing / work aloft',
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        'Refit & Project Support',
        'Dry dock operations',
        'Yacht shipping preparation',
        'Warranty claims',
        'New build / refit deck commissioning',
      ],
    },
    {
