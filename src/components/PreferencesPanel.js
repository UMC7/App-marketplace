...
const RANKS = [
  ...
  "Stew/Nurse", "Laundry/Steward(ess)", "Stew/Massage Therapist", "Stew/Yoga Instructor", "Stew/Hairdresser", "Massage Therapist", "Hairdresser/Barber", "Steward(ess)/Nanny", "Nanny", "Videographer", "Yoga/Pilates Instructor",
