...
const RANKS = [
  ...
  "Stew/Nurse", "Laundry/Steward(ess)", "Stew/Masseur", "Stew/Yoga Instructor", "Stew/Hairdresser", "Masseur", "Hairdresser/Barber", "Steward(ess)/Nanny", "Nanny", "Videographer", "Yoga/Pilates Instructor",
